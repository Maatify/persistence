...
final class ScriptedPdoStatement extends PDOStatement
{
    ...
    /** @param list<mixed> $fetchQueue @param array<string,bool|Throwable> $bindResults */
    public function __construct(private int $columns = 1, private array $fetchQueue = [], private bool|Throwable $executeResult = true, private string|null $errorCode = '00000', private array $bindResults = []) {}
    public static function count(mixed $value): self { return new self(1, [['total_count' => $value], false]); }
