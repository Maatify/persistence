...
final readonly class TransactionSavepointSchemaManager
{
    public const TABLE = 'maa_persistence_test_transaction_savepoint_items';
    ...
    {
        $this->dropTable();
        $this->executeFixture('create_transaction_savepoint_items_table.sql');
    }
